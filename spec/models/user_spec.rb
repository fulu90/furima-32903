...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'passwordとpassword_confirmationは半角英数字混合でないと登録できない' do
      ...
      it 'last_name_kanaは半角英数字では登録できない' do
      ...
      it 'first_name_kanaは半角英数字では登録できない' do
